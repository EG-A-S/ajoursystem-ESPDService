...
<s:eval var="espdEnvironment" scope="page"
	expression="@espdConfiguration.espdEnvironment" />

<form:form id="espdFilterForm" role="form" class="form-horizontal"
	action="filter" method="post" commandName="espdFilterParams"
	...
	<div class="panel-default">
		...
		<div>
			<h2 data-i18n="filter_header">
				<s:message code='filter_header' />
			</h2>
		</div>
		<c:if test="${espdEnvironment == true}">
			<div class="alert alert-danger">
				<ul class="fa-ul">
					<li><i class="error-label fa fa-info-circle fa-lg fa-li"></i>
						<s:message code="app_environment" /> <a
						href="https://ec.europa.eu/espd">https://ec.europa.eu/espd</a></li>
				</ul>
			</div>
		</c:if>
		...
		<div>
			<h3>
				<span data-i18n="filter_who_are_you"><s:message
						code='filter_who_are_you' /></span> <span
			...
			<div class="tab-content">
				<div class="tab-pane" id="tab_ca">
					...
					<div class="row">
						<div class="radio col-md-3">
							<label><form:radiobutton path="action" name="action"
									value="ca_create_espd_request" class="radiotab radioCa"
									data-target="#tab-country-selection" />${span18n['filter_create_espd']}</label>
							<span data-i18n="tooltip_ca_can_create_espd"
								data-toggle="tooltip"
					...
					<div class="row">
						<div class="radio col-md-3">
							<label><form:radiobutton path="action" name="action"
									value="ca_reuse_espd_request" class="radiotab radioCa"
									data-target="#tab-single-upload" />${span18n['filter_reuse_espd']}</label>
							<span data-i18n="tooltip_ca_can_import_espd"
								data-toggle="tooltip"
					...
					<div class="row">
						<div class="radio col-md-3">
							<label><form:radiobutton path="action" name="action"
									value="ca_review_espd_response" class="radiotab radioCa"
				...
				<div class="tab-pane" id="tab_eo">
					<h3 data-i18n="filter_what_you_do">
						<s:message code='filter_what_you_do' />
					</h3>
					<div class="radio">
						<span class="k-button fa fa-upload hoverable"></span> <label><form:radiobutton
								path="action" name="action" value="eo_import_espd"
								class="radiotab radioCa" data-target="#tab-single-upload" />${span18n['filter_import_espd']}</label>
						<span data-i18n="tooltip_filter_eo_can_import_espd"
							data-toggle="tooltip"
							title="${i18n['tooltip_filter_eo_can_import_espd']}"></span>
					</div>
					<div class="radio">
						<span class="k-button fa fa-upload hoverable"></span> <label><form:radiobutton
								path="action" name="action" value="eo_merge_espds"
								class="radiotab radioCa" data-target="#tab-multiple-upload" />${span18n['filter_merge_espds']}</label>
						<span data-i18n="tooltip_filter_eo_merge_espds"
							data-toggle="tooltip"
							title="${i18n['tooltip_filter_eo_merge_espds']}"></span>
					</div>
					<div class="radio">
						<span class="k-button fa fa-upload hoverable"></span> <label><form:radiobutton
								path="action" name="action" value="eo_create_espd_response"
								class="radiotab radioCa" data-target="#tab-country-selection" />${span18n['filter_create_response']}</label>
						<span data-i18n="tooltip_filter_create_response"
							data-toggle="tooltip"
			...
			<div class="tab-content">
				<div class="tab-pane" id="tab-single-upload">
					<h3 data-i18n="filter_upload_document">
						<s:message code='filter_upload_document' />
					</h3>
				...
				<div class="tab-pane" id="tab-multiple-upload">
					<h3 data-i18n="filter_upload_documents">
						<s:message code='filter_upload_documents' />
					</h3>
				...
				<div class="tab-pane" id="tab-country-selection">
					...
					<span data-i18n="filter_select_country"><s:message
							code='filter_select_country' /></span>
